...
//
//	mockgen -source=internal/domain/repository/user_repository.go -destination=internal/domain/repository/mock/user_repository_mock.go -package=mock
//
...
func (m *MockUserRepository) Create(ctx context.Context, user *model.User, passwordHash string) error {
	m.ctrl.T.Helper()
