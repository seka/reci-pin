...
//
//	mockgen -source=recipe_repository.go -destination=./mock/recipe_repository_mock.go -package=mock
//
...
func (m *MockRecipeRepository) GetAll(ctx context.Context) ([]model.Recipe, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRecipeRepositoryMockRecorder) GetAll(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockRecipeRepository)(nil).GetAll), ctx)
}
