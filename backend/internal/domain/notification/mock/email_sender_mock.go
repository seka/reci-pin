...
// Source: internal/domain/notification/email_sender.go
//
// Generated by this command:
//
//	mockgen -source=internal/domain/notification/email_sender.go -destination=internal/domain/notification/mock/email_sender_mock.go -package=mock
//
